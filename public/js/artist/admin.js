...
var Artist = {
	...
	targetURL: siteURL + '/admin/artist/',
	c: 'Artist',
	$lists: '',
	...
	operations: function(cell, opts, rowObj) {
		// Since this = jgrid instance, we explicitly call Artist when necessary
		var targetURL = Artist.targetURL;
		...
		ret += '<a href="javascript:Message.confirmBox(\'Artist.delete(' + cell + ')\', \'' + Artist.c + ' - Delete Record\',\' Are you sure you want to delete selected?\');" title="Delete" class="icon icon-delete"></a>';
